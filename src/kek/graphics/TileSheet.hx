...
import kek.graphics.AsepriteResource;
...
class TileSheet extends hxd.res.Resource {
    ...
    public function toTileSheet() : kek.graphics.TileSheet {
	...
	public function toAnimatedSprite() : kek.graphics.AnimatedSprite {
		return new kek.graphics.AnimatedSprite(this);
	}
}
